          ...
          : SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  optionsMenu(
                    "${userModel.username} ${userModel.compatibility!.shouldChristianSpeakInTongue!.toLowerCase().contains("yes") ? "believes" : "doesn't believe"} speaking in tongues is very necessary",
                  ),
                  optionsMenu(
                    "${userModel.username} ${userModel.compatibility!.believeInTithing!.toLowerCase().contains("yes") ? "believes" : "doesn't believe"} tithing is important",
                  )
                ],
              ),
            ),
