              ...
              Padding(
                ...
                child: Text.rich(
                  TextSpan(children: [
                    const TextSpan(
                        text:
                            "You have successfully created a profile on Nexus! We just launched & new users join everyday! Kindly tell your Christian single friends about Nexus & follow us on social media "),
                    TextSpan(
                        text: " @nexus4singles",
                        style: textStyle18.copyWith(
                            fontSize: 14,
